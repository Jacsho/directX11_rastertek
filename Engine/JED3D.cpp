...
)
{
	...
	// Create the swap chain, Direct3D device, 
	// and Direct3D device context.
	// D3D_DRIVER_TYPE_HARDWARE if video card support DirectX 11
	// otherwise D3D_DRIVER_TYPE_REFERENCE (this will use our CPU)
	...
	result = m_swapChain->GetBuffer(
		0, 
		__uuidof(ID3D11Texture2D), (LPVOID*)&backBufferPtr);
...
//==============================================
ID3D11DeviceContext * JED3D::GetDeviceContext()
{
...
//==============================================
void JED3D::GetProjectionMatrix(
